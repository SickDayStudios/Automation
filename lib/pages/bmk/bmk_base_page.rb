class BMKBasePage < BasePage
	...
	def self.bmk_saved_spec(id)
		Nokogiri::XML.parse(RestClient.get("http://api.spectrumcustomizer.com/benchmade/specification/saved/#{id}"))
	end
	...
	def random_knife
		...
		$driver.goto("http://madetoorder.azureedge.net/benchmade/frontend/index.html#/product/#{asset}")
		self.wait_until { self.buy_element.present? }
		sleep 5
