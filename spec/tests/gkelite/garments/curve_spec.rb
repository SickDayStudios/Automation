...
describe "< #7625: Women's Sleek Curve Long Sleeve Leotard - Customizer Test >" do
  ...
  context 'Area A: Fabric Option 1' do
    ...
    it '- Fabric Hologram: Verify Color Colors' do
  ...
  context 'Embellishments Page: Setup' do
  ...
  context 'Embellishments Page: Additional Designs' do
    ...
    it '- Additional Designs J1243 Color: Close Modal' do
...
#    end
  ...
  context 'Upper Left Sleeve: Custom Artwork' do
    ...
    it '- Lettering & Artwork: Expand Left Sleeve Accordian' do
      @page.sub_accordian_two_element.click
      expect(@page.sub_accordian_label).to include("Left Sleeve")
    end
  ...
  ##    No Mesh     ##
  ####################
  context 'Full Left Sleeve: Custom Artwork' do
...
##########################################################################
  ...
  context 'Upper Right Sleeve: Custom Artwork' do
    ...
    it '- Lettering & Artwork: Expand Right Sleeve Accordian' do
      @page.sub_accordian_two_element.click
      expect(@page.sub_accordian_label).to include("Right Sleeve")
    end
  ...
  context 'Full Right Sleeve: Custom Artwork' do
