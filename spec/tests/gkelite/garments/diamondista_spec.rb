...
describe "< #7616s: Women's Diamondnista Sublimated Leotard - Customizer Unit Test >" do
  ...
  context 'Area B: Fabric Option 1: Sublimation on Polytek' do
 ...
 ###########################
  ...
  context 'Upper Left Sleeve: Custom Artwork' do
  	...
  	it '- Upper Left Sleeve: Embellishment Types' do
  		...
  		expect(@arr).to include("Sequinz", "Crystals", "Spanglez")
  	end
