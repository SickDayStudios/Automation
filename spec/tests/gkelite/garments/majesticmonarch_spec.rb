...
describe "< #9608: Women's Majestic Monarch Leotard - Customizer Unit Test >" do
  ...
  context 'Area A: Fabric Option 3' do
    ...
    it '- Fabric Sublimation on Mesh: Purple Combo Options' do
    ...
    it '- Fabric Sublimation on Mesh: Patriotic Combo Options' do
    ...
    it '- Fabric Sublimation on Mesh: Blue Combo Options' do
    ...
    it '- Fabric Sublimation on Mesh: Enable Reverse Gradient Button' do
      @page.reverse_button_element.click 
      expect(@page.reverse_button_enabled?).to eq(true)
    end

    it '- Fabric Sublimation on Mesh: Reverse Pink Gradients' do      
      @page.color_combo_dropdown=@page.color_combo_dropdown_options[0]
      @page.reverse_button_element.click
      @page.gradient_grid_elements.each do |x|
        x.click
    ...
    it '- Fabric Sublimation on Mesh: Reverse Purple Gradients' do      
      @page.color_combo_dropdown=@page.color_combo_dropdown_options[1]
      @page.reverse_button_element.click
      @page.gradient_grid_elements.each do |x|
        x.click
    ...
    it '- Fabric Sublimation on Mesh: Reverse Patriotic Gradients' do      
      @page.color_combo_dropdown=@page.color_combo_dropdown_options[2]
      @page.reverse_button_element.click
      @page.gradient_grid_elements.each do |x|
        x.click
    ...
    it '- Fabric Sublimation on Mesh: Reverse Blue Gradients' do      
      @page.color_combo_dropdown=@page.color_combo_dropdown_options[3]
      @page.reverse_button_element.click
      @page.gradient_grid_elements.each do |x|
        x.click
    ...
    it '- Fabric Sublimation on Mesh: Set 2-Color Colorcount' do
    ...
    it '- Fabric Sublimation on Mesh: Red Combo Options' do
    ...
    it '- Fabric Sublimation on Mesh: Green Combo Options' do
    ...
    it '- Fabric Sublimation on Mesh: Reverse Pink Combo Options' do
      @page.color_combo_dropdown=@page.color_combo_dropdown_options[0]
      @page.reverse_button_element.click 
      @page.gradient_grid_elements.each do |x|
        x.click
    ...
    it '- Fabric Sublimation on Mesh: Reverse Purple Combo Options' do
      @page.color_combo_dropdown=@page.color_combo_dropdown_options[1]
      @page.reverse_button_element.click 
      @page.gradient_grid_elements.each do |x|
        x.click
    ...
    it '- Fabric Sublimation on Mesh: Reverse Blue Combo Options' do
      @page.color_combo_dropdown=@page.color_combo_dropdown_options[3]
      @page.reverse_button_element.click 
      @page.gradient_grid_elements.each do |x|
        x.click
    ...
    it '- Fabric Sublimation on Mesh: Reverse Red Combo Options' do
      @page.color_combo_dropdown=@page.color_combo_dropdown_options[4]
      @page.reverse_button_element.click 
      @page.gradient_grid_elements.each do |x|
        x.click
    ...
    it '- Fabric Sublimation on Mesh: Reverse Green Combo Options' do
      @page.color_combo_dropdown=@page.color_combo_dropdown_options[5]
      @page.reverse_button_element.click 
      @page.gradient_grid_elements.each do |x|
        x.click
    ...
    it '- Fabric Sublimation on Mesh: Close Gradient Modal' do
      @page.gradient_modal_close_element.click
      expect(@page.gradient_modal_popup?).to eq(false)
    end
    ...
    it 'Sleeve Lining Fabric: No Mesh Lining' do
      @page.third_dropdown=@page.third_dropdown_options[4]
      expect(@page.edit_third_color?).to eq(false)
    end
  ...
  context 'Embellishments: Set 1' do
  ...
  context 'Embellishments Page: Additional Designs' do
    ...
    it '- Additional Designs J1146 Color: Close Modal' do
      @page.embellishment_modal_close_three_element.click
      expect(@page.embellishment_modal_header_three?).to eq(false)
    end

    it '- Additional Designs Option: J1120' do
      @page.multioption_four_element.click
      expect(@page.multioption_four_element.attribute('class')).not_to include('select-none')
    end

    it '- Additional Designs Option: J1120 Edit Color' do
      @page.multioption_four_color_element.click 
      expect(@page.color_modal_popup?).to eq(true)     
    end

    it '- Additional Designs Option: J1120 Color Options' do
      @page.color_grid_elements.each do |x|
        x.click
    ...
    it '- Additional Designs J1120 Color: Close Modal' do
...
############################################################################### 
  ...
  context 'Embellishments Page: Upper Left Sleeve Artwork' do
    ...
    it '- Left Sleeve: Upper Location' do
      ...
      @page.sleeve_location_dropdown_element.click
    ...
    it '- Upper Left Sleeve: Artwork Add Comment' do
      @page.art_comment_alt_element.send_keys 'This is a Test', :return
...
###############################################################################
  ...
  context 'Additional Options Page: Additional Options' do
    ...
    it '- Adult Leg Cut: Options' do
      @page.adult_leg_dropdown_element.click
    ...
    it '- Child Leg Cut: Options' do
      @page.child_leg_dropdown_element.click
    ...
    it '- Crotch Liner: Options' do
      @page.crotch_liner_dropdown_element.click
