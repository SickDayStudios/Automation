...
describe "< #7601: Women's Trimmed Up Long Sleeve Leotard - Customizer Unit Test >" do
...
###### Fabric Option 4 ########
  ...
  context 'Design & Color Page: Area 2' do
  ...
  context 'Area 2: Fabric Option' do
    ...
    it '- Zig Zag Trim: Close Color Modal' do
      @page.first_color_modal_close_element.click
      expect(@page.first_modal_header?).to eq(false)
    end
...
#########################
  ...
  context 'Additional Designs: Option 2' do
    ...
    it '- Additional Designs J1142 Color: Close Modal' do
  ...
  context 'Additional Designs: Option 3' do
    ...
    it '- Additional Designs J1143 Color: Close Modal' do
  ...
  context 'Additional Designs: Option 4' do
    ...
    it '- Additional Designs T1155 Color: Close Modal' do
