...
describe "< #7557: Women's Cascading Ribbon Gymnastics Leotard - Customizer Unit Test >" do

  before(:all) do
    @page = CustomizerPage.new
    @page.cascadingribbon
  end
...
##################
  ...
  context 'GK Logo: Style Option 1' do
  ...
  context 'GK Logo: Style Option 2' do
...
#########################
  ...
  context 'Additional Designs: Option 1' do
    it '- Additional Designs Option: J14' do
      ...
      expect(@page.multioption_one_element.text).to include("J14")
    end
  ...
  context 'Additional Designs: Option 2' do
    it '- Additional Designs Option: J750' do
      @page.multioption_two_element.click
      expect(@page.multioption_two_element.attribute('class')).not_to include('select-none')
      expect(@page.multioption_two_element.text).to include("J750")
    end

    it '- Additional Designs Option: J750 Edit Color' do
      @page.multioption_two_color_element.click
      expect(@page.color_modal_popup?).to eq(true)      
    end

    it '- Additional Designs Option: J750 Color Options' do
      @page.color_grid_elements.each do |x|
        x.click
    ...
    it '- Additional Designs J750 Color: Close Modal' do
  ...
  context 'Embellishments Page: Front Right Hip Artwork' do
    ...
    it '- Front Right Hip: Embellishment Types' do
      ...
      expect(@arr).to include("Crystals", "Imprinting")
    end
...
##########################################################################
  ...
  context 'Full Left Sleeve: Lettering' do
    ...
    it '- Full Left Sleeve Font Options: Verify Fonts' do
      @page.font_dropdown_list_elements.each do |x|
        @page.font_dropdown_element.click
        x.click
        @arr.push(@page.font_dropdown)
    ...
    it '- Full Left Sleeve Orientation Options: Cycle Options' do
...
#    it '- Full Left Sleeve: None Radio' do
...
#    it '- Full Right Sleeve: None Radio' do
#      @page.none_element.click
#      expect(@page.upper_embellishment_type_element.present?).to eq(false)
#    end
