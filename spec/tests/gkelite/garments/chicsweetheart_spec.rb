...
describe "< #7562: Women's Chic Sweetheart Competition Leotard - Customizer Unit Test >" do
...
###### Fabric Option 1 ########
  ...
  context 'Area B: Fabric Option 2' do
    it '- Neck Binding Fabric: Mesh' do
      @page.first_dropdown=@page.first_dropdown_options[1]
  ...
  context 'Area B: Fabric Option 4' do
...
#########################
  ...
  context 'Additional Designs: Option 2' do
    ...
    it '- Additional Designs J830 Color: Close Modal' do
  ...
  context 'Additional Designs: Option 3' do
    ...
    it '- Additional Designs J831 Color: Close Modal' do
  ...
  context 'Additional Designs: Option 4' do
    ...
    it '- Additional Designs T724 Color: Close Modal' do
