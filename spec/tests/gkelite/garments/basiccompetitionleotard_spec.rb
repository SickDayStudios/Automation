...
##########################
  ...
  context 'Design & Color Page: Area A' do
    ...
    it '- Set Fabric Option 1: Hologram' do
      @page.first_dropdown_element.click
  ...
  ###### Fabric Option 2 ########
    ...
    it '- Set Fabric Option 2: Velvet' do
      @page.first_dropdown_element.click
    ...
    it '- Fabric Velvet: Color Modal' do
      @page.edit_first_color_element.focus
      @page.edit_first_color_element.click
      expect(@page.color_modal_popup?).to eq(true)
    end

    it '- Fabric Velvet: Verify Colors' do
      @page.color_grid_elements.each do |x|
        x.click
        @arr.push(@page.first_modal_header)
      end
      expect(@arr.sort).to match_array($velvet_colors.sort)
    end

    it '- Fabric Velvet: Close Color Modal' do
      @page.first_color_modal_close_element.click
      expect(@page.color_modal_popup?).to eq(false)
    end
...
##################
  ...
  context 'Design & Color Page: GK Logo' do
    ...
    it '- GK Logo: Verify Embroidery Colors' do
      ...
      expect($embroidery_colors).to include(@arr)
    end
...
#    end
  ...
  context 'Embellishments Page: Front Center Chest Lettering' do
    ...
    it '- Lettering Non-Mesh Options: Text Line 1' do
      @page.embellishment_type=@page.embellishment_type_options[0]
      @page.position=@page.position_options[1]
      @page.text_line_one_element.send_keys 'Test Test Test Test Test Test Test', :return
      expect(@page.text_line_one).to include('Test Test Test Test Test')
    end

    it '- Lettering Non-Mesh Options: Text Line 2' do
      @page.text_line_two_alt_element.send_keys 'Test Test Test Test Test Test Test', :return
    ...
    it '- Front Center Chest: Lettering Add Comment' do
      @page.comment_element.send_keys 'This is a Test', :return
...
#    end
  ...
  context 'Upper Left Sleeve: Custom Artwork' do
    ...
    it '- Upper Left Sleeve: Embellishment Types' do
      @page.upper_embellishment_type_element.click
  ...
  context 'Upper Left Sleeve: Lettering' do
    ...
    it '- Lettering Non-Mesh Options: Verify Orientation Options' do
      @page.upper_embellishment_type_element.click
      @page.upper_embellishment_type=@page.upper_embellishment_type_options[0]
      @page.lettering_orientation_element.click
      expect(@page.lettering_orientation_options).to eq($font_orientation)
    end
    ...
    it '- Lettering Non-Mesh Options: Text Line 1' do
      @page.embellishment_type=@page.embellishment_type_options[0]
      @page.lettering_position_element.click
      @page.lettering_position=@page.lettering_position_options[1]
      @page.text_line_one_element.send_keys 'Test Test Test Test Test Test Test', :return
      expect(@page.text_line_one).to include('Test Test Test Test Test')
    end
    ...
    it '- Lettering Non-Mesh Options: Text Line 2' do
      @page.text_line_two_element.send_keys 'Test Test Test Test Test Test Test', :return
    ...
    it '- Upper Left Sleeve: Lettering Add Comment' do
      @page.lettering_comment_element.send_keys 'This is a Test', :return
...
#    end
  ...
  context 'Upper Right Sleeve: Custom Art' do
    ...
    it '- Right Sleeve: Artwork Add Comment' do
      @page.artwork_comment_element.send_keys 'This is a Test', :return
      expect(@page.artwork_comment).to include("This is a Test")
    end
  end
  ...
  context 'Full Right Sleeve: Custom Art' do
    ...
    it '- Right Sleeve: Embellishment Types' do
      @page.full_embellishment_type_element.click
      @page.full_embellishment_type_options.each do |x|
        @page.full_embellishment_type=x
        @page.full_embellishment_type_element.click
        @arr.push(x)
    ...
    it '- Right Sleeve: Artwork Add Comment' do
      @page.artwork_comment_alt_element.send_keys 'This is a Test', :return
      expect(@page.artwork_comment_alt).to include("This is a Test")
    end
