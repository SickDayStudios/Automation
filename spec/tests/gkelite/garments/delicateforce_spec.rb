...
describe "< #7622: Women's Delicate Force Leotard Customizer Test >" do
 ...
 # end
  ...
  context 'Area B: Fabric Option 3' do
    it '- Set Fabric Option 3: Sublimation on Mesh' do
  ...
  context 'Sublimation on Mesh: 3-Color Gradient Options' do
    it '- Fabric Sublimation on Mesh: Set 3-Color Colorcount' do
      @page.colorcount_dropdown_element.click
  ...
  context 'Sublimation on Mesh: 2-Color Gradient Options' do
  ...
  context 'Sublimation on Mesh: Bodice Lining Option 2' do
    ...
    ############################
  context 'Sublimation on Mesh: Bodice Lining Option 3' do
  ...
  context 'Sublimation on Mesh: Sleeve Lining Option 2' do
    ...
    ############################
  context 'Sublimation on Mesh: Sleeve Lining Option 3' do
...
#########################
  ...
  context 'Embellishments Page: Set 2' do
    ...
    it '- Set 2 Option: T1330' do
      @page.single_option_two_element.click
      expect(@page.single_option_two_element.attribute('class')).not_to include('select-none')
    end

    it '- Set 2 Option: T1333' do
      @page.single_option_three_element.click
      expect(@page.single_option_three_element.attribute('class')).not_to include('select-none')
    end
  ...
  context 'Embellishments Page: Additional Designs' do
    ...
    it '- Additional Designs J1238 Color: Close Modal' do
...
##########################################################################
  ...
  context 'Embellishments Page: Center Back Lettering' do
    ...
    it '- Imprinting Embellishment Type: Color Modal' do
      @page.lettering_color_alt_element.click
      expect(@page.lettering_modal_close_alt?).to eq(true)
    end
    ...
    it '- Imprinting Embellishment Type: Close Modal' do
      @page.lettering_modal_close_alt_element.click
      expect(@page.lettering_modal_close_alt?).to eq(false)
    end

    it '- Lettering Font Options: Verify Fonts' do
      @page.font_dropdown_list_elements.each do |x|
        @page.font_dropdown_element.click
        x.click
    ...
    it '- Lettering Text Options: One Line Position' do
      @page.position=@page.position_options[0]
      expect(@page.text_line_one?).to eq(true)
    end

    it '- Lettering Text Options: Two Line Position' do
      @page.position=@page.position_options[1]
      expect(@page.text_line_two_alt?).to eq(true)
    end
