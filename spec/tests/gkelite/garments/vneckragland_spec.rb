...
describe "< #4882: V-Neck Ragland Leotard - Customizer Unit Test >" do
...
##########################
  ...
  #####################
    ...
    it 'Bodice Lining Fabric: Nylon/Spandex Liner' do
    ...
    it '- Cycle Bodice Lining: Nylon/Spandex Liner Colors' do
      @page.color_grid_elements.each do |x|
        x.click
        @arr.push(@page.color_modal_header)
      end
  ...
  context 'Design & Color Page: Area 1' do
    ...
    it '- Cycle Velvet Colors' do
      ...
      expect(@arr.sort).to match_array($velvet_colors)
    end
...
#########################
  ...
  context 'Navigate to Embellishments Page' do
...
##########################
  ...
  context 'Embellishments Page: Additional Designs' do
    ...
    it '- Additional Designs J942 Color: Close Modal' do
