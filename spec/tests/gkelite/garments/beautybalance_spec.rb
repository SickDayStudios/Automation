...
context 'Embellishments Page: Embellishment Designs' do
  ...
  context 'Additional Designs: Option 2' do
    ...
    it '- Additional Designs J1131 Color: Close Modal' do
  ...
  context 'Additional Designs: Option 3' do
    ...
    it '- Additional Designs J1133 Color: Close Modal' do
  ...
  context 'Additional Designs: Option 4' do
    ...
    it '- Additional Designs J1134 Color: Close Modal' do
    ...
    it '- Additional Designs T1127 Color: Close Modal' do
    ...
    it '- Additional Designs T1128 Color: Close Modal' do
  ...
  context 'Embellishments Page: Cuff Designs' do
    ...
    it '- Cuff Designs Option: T249' do
      ...
      expect(@page.single_option_two_element.text).to include("T249")
    end
    ...
    it '- Cuff Designs Option: T728' do
      ...
      expect(@page.single_option_three_element.text).to include("T728")
    end
    ...
    it '- Cuff Designs Option: T860' do
      ...
      expect(@page.single_option_four_element.text).to include("T860")
    end
    ...
    it '- Cuff Designs Option: None' do
      ...
      expect(@page.single_option_five_element.text).to include("None")
    end
  ...
  context 'Embellishments Page: Front Center Chest Artwork' do
    ...
    it '- Front Center Chest: Artwork Add Comment' do
      @page.art_comment_alt = 'This is a Test'
  ...
  context 'Embellishments Page: Front Center Chest Lettering' do
    ...
    it '- Lettering Non-Mesh Options: Text Line 1' do
      @page.embellishment_type=@page.embellishment_type_options[0]
      @page.position=@page.position_options[1]
      @page.text_line_one = 'Test Test Test Test Test Test Test'
      expect(@page.text_line_one).to include('Test Test Test Test Test')
    end

    it '- Lettering Non-Mesh Options: Text Line 2' do
      @page.text_line_two_alt = 'Test Test Test Test Test Test Test'
  ...
  context 'Upper Left Sleeve: Lettering' do
    ...
    it '- Lettering Options: Text Line 2' do
      @page.text_line_two = 'Test Test Test Test Test Test Test'
    ...
    it '- Upper Left Sleeve: Lettering Add Comment' do
      @page.lettering_comment = 'This is a Test'
...
#    end
  ...
  context 'Full Left Sleeve: Custom Art' do
    ...
    it '- Full Left Sleeve: Artwork Add Comment' do
      @page.full_art_comment = 'This is a Test'
...
##########################################################################
  context 'Full Left Sleeve: Lettering' do
    ...
    it '- Full Left Sleeve: Lettering Add Comment' do
      @page.full_letter_comment = 'This is a Test'
  ...
  context 'Upper Right Sleeve: Lettering' do
    ...
    it '- Lettering Embellishment Types: Small Embroidery Colors' do
      @page.full_embellishment_type=@page.full_embellishment_type_options[0]
      @page.edit_full_letter_color_element.click
      @page.color_grid_elements.each do |x|
        x.click
        @arr.push(@page.full_lettering_header)
    ...
    it '- Lettering: Close Modal' do
      @page.close_full_letter_modal_element.click
      expect(@page.close_full_letter_modal?).to eq(false)
    end

    it '- Lettering Embellishment Types: Imprinting Colors' do
      @page.full_embellishment_type=@page.full_embellishment_type_options[1]
      @page.edit_full_letter_color_element.click
      @page.color_grid_elements.each do |x|
        x.click
        @arr.push(@page.full_lettering_header)
    ...
    it '- Lettering Imprinting: Disable Two Line' do
      expect(@page.lettering_position_full_options).not_to include('Two Line')
    end
    ...
    it '- Lettering Options: Orientation' do
      ...
      expect(@page.full_orientation_options).to eq($orientation_upper)
    end

    it '- Vertical Up Orientation: Position Dropdown Unavailable' do
      @page.full_orientation=@page.full_orientation_options[1]
      expect(@page.lettering_position_full_element.present?).to eq(false)
    end

    it '- Vertical Down Orientation: Position Dropdown Unavailable' do
      @page.full_orientation=@page.full_orientation_options[2]
      expect(@page.lettering_position_full_element.present?).to eq(false)
    end

    it '- Horizontal Orientation: Position Dropdown Available' do
      @page.full_orientation=@page.full_orientation_options[0]
      expect(@page.lettering_position_full_element.present?).to eq(true)
    end

    it '- Lettering Options: One Line Position' do
      @page.full_orientation=@page.full_orientation_options[0]
      @page.lettering_position_full=@page.lettering_position_full_options[0]
      expect(@page.two_line_text_element.present?).to eq(false)
    end

    it '- Lettering Options: Two Line Position' do
      @page.lettering_position_full=@page.lettering_position_full_options[1]
      expect(@page.two_line_text_element.present?).to eq(true)
    end

    it '- Lettering Text Position: Curved Line' do
      @page.lettering_position_full=@page.lettering_position_full_options[2]
      expect(@page.two_line_text_element.present?).to eq(false)
    end
    ...
    it '- Lettering Options: Text Line 2' do
      @page.two_line_text = 'Test Test Test Test Test Test Test'
      expect(@page.two_line_text).to include('Test Test Test Test Test')
    end
  ...
  context 'Embellishments Page: Full Right Sleeve Artwork' do

    it '- Right Sleeve: Full Location' do
    ...
    it '- Right Sleeve: Custom Artwork Radio' do
      @page.art_radio_element.click
      expect(@page.art_radio_element.set?).to eq(true)
    end
    ...
    it '- Right Sleeve: Artwork Add Comment' do
      @page.artwork_comment = 'This is a Test'
      expect(@page.artwork_comment).to include("This is a Test")
    end
...
##########################################################################
  context 'Full Right Sleeve: Lettering' do
    ...
    it '- Full Right Sleeve: Lettering Radio' do
      @page.lettering_radio_element.click
      expect(@page.lettering_radio_element.set?).to eq(true)
    end
    ...
    it '- Full Right Sleeve Lettering Color: Close Modal' do
      @page.lettering_modal_close_element.click
      expect(@page.lettering_modal_close?).not_to eq(true)
    end
