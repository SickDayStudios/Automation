...
describe "< #7626: Women's Draped Symmetry Competition Leotard - Customizer Unit Test >" do
  ...
  context 'Design & Color Page: Sleeve Length' do
    ...
    it '- Set 3/4 Sleeve' do
      ...
      expect(@page.three_quarter_element.set?).to eq(true)
    end
...
############################
  ...
  context 'Bodice Lining Fabric: Option 3' do
    ...
    it '- Cycle Bodice Lining: Shadowproof Liner' do
      @page.color_grid_elements.each do |x|
        x.click
        @arr.push(@page.color_modal_header)
      end
  ...
  context 'Design & Color Page: Area C' do
    ...
    it '- Area C: Close Color Modal' do
      @page.first_color_modal_close_element.click
      expect(@page.first_modal_header?).to eq(false)
    end

    it '- Area C Fabric: Nylon/Spandex with Foil' do
      @page.first_dropdown=@page.first_dropdown_options[1]
      expect(@page.first_dropdown).to include('Nylon/Spandex with Foil')
    end
...
#########################
  ...
  context 'Embellishments Page: Additional Designs' do
    ...
    it '- Additional Designs J1240 Color: Close Modal' do
    ...
    it '- Additional Designs J1241 Color: Close Modal' do
    ...
    it '- Additional Designs J1340 Color: Close Modal' do
      @page.embellishment_modal_close_four_element.click
      expect(@page.embellishment_modal_header_four?).to eq(false)
    end
