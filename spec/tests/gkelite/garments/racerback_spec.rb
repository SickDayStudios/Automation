...
describe "< #4895: Women's Racerback Sport Long Sleeve Leotard - Customizer Unit Test >" do
...
##################
  ...
  context 'Area E: Fabric Option 1' do
    ...
    ## Lining Option 1 ##
    ############################
  context 'Sublimation on Mesh: Lining Option 1' do
    ...
    ## Lining Option 2 ##
    ############################
  context 'Sublimation on Mesh: Lining Option 2' do
  ...
  context 'Sublimation on Mesh: Lining Option 2' do
    ...
    ## Lining Option 4 ##
    ############################
  context 'Sublimation on Mesh: Lining Option 4' do
...
#########################
  ...
  context 'Embellishments Page: Set 2' do
    ...
    it '- Set 2 Option: T1369' do
      @page.single_option_two_element.click
      expect(@page.single_option_two_element.attribute('class')).not_to include('select-none')
    end

    it '- Set 2 Option: T1366' do
      @page.single_option_three_element.click
      expect(@page.single_option_three_element.attribute('class')).not_to include('select-none')
    end
  ...
  context 'Additional Designs: Option 2' do
    ...
    it '- Additional Designs J1252 Color: Close Modal' do
  ...
  context 'Additional Designs: Option 3' do
    ...
    it '- Additional Designs J1253 Color: Close Modal' do
  ...
  context 'Additional Designs: Option 4' do
    ...
    it '- Additional Designs J1254 Color: Close Modal' do
